...
Event.create(name: "Oddisee presented by Collective Minds x Kilo Lounge",
             ...
             starttime: DateTime.strptime("12/14/2019 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/15/2019 01:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "BlackKajiXtra - Acid Mothers Temple & The Melting Paraiso UFO",
             ...
             starttime: DateTime.strptime("12/22/2019 19:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/22/2019 22:30", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Gimme Shelter",
             ...
             starttime: DateTime.strptime("12/17/2019 21:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2019 03:30", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sunset Pasar & Disco 2.0",
             ...
             starttime: DateTime.strptime("12/17/2019 13:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/17/2019 21:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sunday Social Market",
            ...
            Expect some good ol' House music, artisanal bakers and crafters, interior decor, fashion accessories and of course the hearty roasts from Camp Kilo Charcoal Club.",
             starttime: DateTime.strptime("12/18/2019 12:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2019 22:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Crowd CTRL Presents LeNERD & Sayvere with DJ Rey & TMO",
            ...
            THIS EVENT IS 21+",
             starttime: DateTime.strptime("12/17/2019 22:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2019 04:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Do The Hustle",
            ...
            ",
             starttime: DateTime.strptime("12/17/2019 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2019 03:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Electric Feel: C'mon Do The 80s With Me",
            ...
            This is our penultimate party of 2019, so you Maneaters and Ladykillers, go the full nine yards and get into the groove with your craziest costumes, facepaints, glitter, fab hair, and get physical with us on the dancefloor! ",
             starttime: DateTime.strptime("11/24/2019 22:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("11/18/2019 04:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "The Foundation presents Dicky Trisco",
            ...
            .
            LET’S DANCE!!!",
             starttime: DateTime.strptime("12/09/2019 20:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/10/2019 02:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sundown Sundays",
            ...
            ",
             starttime: DateTime.strptime("12/11/2019 16:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/11/2019 10:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Council Mondays: Deen, Haan, Cats On Crack & Maurice Simon",
            ...
            ",
             starttime: DateTime.strptime("12/05/2019 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/06/2019 01:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "After Dark with Rødhåd (GER) and James Riach",
            ...
            He caught his big break in the same year, as he was featured and interviewed as BREAKTHROUGH ARTIST OF THE YEAR on the paramount website for electronic music",
             starttime: DateTime.strptime("11/05/2019 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("11/06/2019 01:00", "%m/%d/%Y %H:%M"),
