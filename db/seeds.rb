...
Event.create(name: "Oddisee presented by Collective Minds x Kilo Lounge",
             ...
             starttime: DateTime.strptime("12/14/2018 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/15/2018 01:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "BlackKajiXtra - Acid Mothers Temple & The Melting Paraiso UFO",
             ...
             starttime: DateTime.strptime("12/22/2018 19:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/22/2018 22:30", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Gimme Shelter",
             ...
             starttime: DateTime.strptime("12/17/2018 21:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2018 03:30", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sunset Pasar & Disco 2.0",
             ...
             starttime: DateTime.strptime("12/17/2018 13:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/17/2018 21:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sunday Social Market",
            ...
            Expect some good ol' House music, artisanal bakers and crafters, interior decor, fashion accessories and of course the hearty roasts from Camp Kilo Charcoal Club.",
             starttime: DateTime.strptime("12/18/2018 12:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2018 22:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Crowd CTRL Presents LeNERD & Sayvere with DJ Rey & TMO",
            ...
            THIS EVENT IS 21+",
             starttime: DateTime.strptime("12/17/2018 22:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2018 04:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Do The Hustle",
            ...
            ",
             starttime: DateTime.strptime("12/17/2018 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2018 03:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "The Foundation presents Dicky Trisco",
            ...
            .
            LET’S DANCE!!!",
             starttime: DateTime.strptime("12/09/2018 20:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/10/2018 02:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sundown Sundays",
            ...
            ",
             starttime: DateTime.strptime("12/11/2018 16:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/11/2018 10:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Council Mondays: Deen, Haan, Cats On Crack & Maurice Simon",
            ...
            ",
             starttime: DateTime.strptime("12/05/2018 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/06/2018 01:00", "%m/%d/%Y %H:%M"),
