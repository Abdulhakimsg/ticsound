...
Event.create(name: "Oddisee presented by Collective Minds x Kilo Lounge",
             ...
             starttime: DateTime.strptime("12/14/2021 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/15/2021 01:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "BlackKajiXtra - Acid Mothers Temple & The Melting Paraiso UFO",
             ...
             starttime: DateTime.strptime("12/22/2021 19:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/22/2021 22:30", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Gimme Shelter",
             ...
             starttime: DateTime.strptime("12/17/2021 21:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2021 03:30", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sunset Pasar & Disco 2.0",
             ...
             starttime: DateTime.strptime("12/17/2021 13:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/17/2021 21:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sunday Social Market",
            ...
            Expect some good ol' House music, artisanal bakers and crafters, interior decor, fashion accessories and of course the hearty roasts from Camp Kilo Charcoal Club.",
             starttime: DateTime.strptime("12/18/2021 12:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2021 22:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Crowd CTRL Presents LeNERD & Sayvere with DJ Rey & TMO",
            ...
            THIS EVENT IS 21+",
             starttime: DateTime.strptime("12/17/2021 22:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2021 04:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Do The Hustle",
            ...
            ",
             starttime: DateTime.strptime("12/17/2021 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/18/2021 03:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Electric Feel: C'mon Do The 80s With Me",
            ...
            This is our penultimate party of 2021, so you Maneaters and Ladykillers, go the full nine yards and get into the groove with your craziest costumes, facepaints, glitter, fab hair, and get physical with us on the dancefloor! ",
             starttime: DateTime.strptime("11/24/2021 22:30", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("11/18/2021 04:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "The Foundation presents Dicky Trisco",
            ...
            .
            DICKY TRISCO >>>>
            DT has been at the heart of the disco resurgence through his output on various big-hitting labels such as Disco Deviance, Down In The Basement, Barefoot Beats, Kolour and Labor Of Love amongst others, and through his pioneering production work as part of Boogie Corporation (2021 Vision).
            .
            ...
            .
            LET’S DANCE!!!",
             starttime: DateTime.strptime("12/09/2021 20:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/10/2021 02:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Sundown Sundays",
            ...
            ",
             starttime: DateTime.strptime("12/11/2021 16:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/11/2021 10:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "Council Mondays: Deen, Haan, Cats On Crack & Maurice Simon",
            ...
            ",
             starttime: DateTime.strptime("12/05/2021 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("12/06/2021 01:00", "%m/%d/%Y %H:%M"),
...
Event.create(name: "After Dark with Rødhåd (GER) and James Riach",
            ...
            He caught his big break in the same year, as he was featured and interviewed as BREAKTHROUGH ARTIST OF THE YEAR on the paramount website for electronic music",
             starttime: DateTime.strptime("11/05/2021 21:00", "%m/%d/%Y %H:%M"),
             endtime: DateTime.strptime("11/06/2021 01:00", "%m/%d/%Y %H:%M"),
